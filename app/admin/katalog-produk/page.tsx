...
//       // Siapkan parameter API - PERBAIKAN: Gunakan parameter yang sesuai dengan backend
//       const params: any = {
//         type: "inti",
//         page,
...
//       // Tambahkan filter jika ada - PERBAIKAN: Gunakan parameter yang benar
//       if (filterParams.query) {
//         params.search = filterParams.query; // atau 'name' tergantung backend
//       }
//       if (filterParams.tahap) {
//         params.tahap_id = filterParams.tahap;
//       }
//       if (filterParams.kategori) {
...
//             {filters.query && <span className="bg-orange-100 text-orange-800 px-2 py-1 rounded-md text-xs">Pencarian: "{filters.query}"</span>}
//             {filters.tahap && <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs">Tahap: {filters.tahap}</span>}
//             {filters.kategori && <span className="bg-green-100 text-green-800 px-2 py-1 rounded-md text-xs">Kategori: {filters.kategori}</span>}
//             <Button variant="outline" size="sm" onClick={handleResetFilters} className="ml-2">
//               Reset Semua Filter
//             </Button>
//           </div>
//         )}
...
//                     return (
//                       <tr key={item.id} onClick={() => router.push(`/katalog-produk/${item.id}`)} className={`cursor-pointer hover:bg-gray-50 ${index === crossProducts.length - 1 ? "" : "border-b"}`}>
//                         <td className="py-3 px-4 font-medium">
//                           <div className="flex flex-col gap-2">
//                             <div className="flex items-center gap-2">
//                               <span>{item.name}</span>
