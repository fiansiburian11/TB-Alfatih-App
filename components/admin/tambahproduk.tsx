...
// //       formData.append("img_product", file); // sesuai format backend kamu

// //       const res = await api.post("/private/as/product/img", formData, {
// //         headers: { "Content-Type": "multipart/form-data" },
// //       });

// //       // Pastikan path-nya sesuai respons backend
// //       if (res.data?.data?.img_product) {
// //         setUploadedImagePaths((prev) => [...prev, res.data.data.img_product]);
// //         showSuccessToast(`Berhasil upload ${file.name}`);
// //       } else {
...
// //     showErrorToast("Gagal upload gambar");
// //   } finally {
...
// //        if (res.data?.data?.img_product) {
// //          uploadedPaths.push(res.data.data.img_product);
// //        } else {
// //          console.error("Response upload tidak sesuai format:", res.data);
// //        }
// //      } catch (err) {
// //        console.error("Gagal upload gambar:", err);
// //        showErrorToast("Gagal upload salah satu gambar");
// //      }
// //    }
...
// //     try {
// //       // Validasi dasar
// //       if (!formData.namaProduk || !formData.jenisProduk || !selectedKategoriId) {
...
// //       // 🔹 Upload gambar dulu (bisa banyak)
// //       const uploadedImagePaths = await uploadImages();

// //       if (uploadedImagePaths.length === 0) {
// //         showErrorToast("Minimal upload 1 gambar produk!");
// //         return;
// //       }
...
// //         cross_selling_id: selectedCrossSellingIds,
// //         img_product: uploadedImagePaths, // ⬅️ Array hasil upload
// //       };
...
// //       showErrorToast(error.message || "Gagal menambah produk inti");
// //     } finally {
// //       setLoading(false);
// //     }
// //   };
...
// //                       <img src={src} alt={`preview-${index}`} className="w-full h-24 object-cover rounded-lg border" />
// //                       <button type="button" onClick={() => handleRemoveImage(index)} className="absolute top-1 right-1 bg-red-500 text-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition">
// //                         <X className="w-4 h-4" />
// //                       </button>
// //                     </div>
// //                   ))}
...
// //                 <input type="file" accept=".jpg,.png" multiple className="hidden" id="upload" onChange={handleImageChange} />
// //                 <label htmlFor="upload" className="cursor-pointer flex flex-col items-center gap-2">
// //                   <Upload className="w-6 h-6 text-gray-500" />
// //                   <p className="text-sm text-gray-500">Upload Foto (bisa banyak, jpg/png, max 10 MB)</p>
// //                 </label>
// //               </div>
// //             </div>
...
// //               Kembali
// //             </Button>
// //             <Button type="submit" className="bg-[#0892D8] hover:bg-[#0892D8]/90" disabled={loading || selectedCrossSellingIds.length !== 3}>
...
//         showSuccessToast(`Berhasil upload ${images[i].file.name}`);
//       }
...
//         cross_selling_id: selectedCrossSellingIds.join(","), // Convert array to comma-separated string
//       };
