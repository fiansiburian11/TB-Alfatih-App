...
export default function SidebarStaf({ open, setOpen }: SidebarProps) {
  ...
  const menus = [
    { name: "Dashboard", icon: Home, href: "/staff/dashboard" },
    { name: "Katalog Produk", icon: BookOpen, href: "/staff/katalog-produk" },
    { name: "Riwayat Sales Order", icon: FileText, href: "/staff/riwayat-sales-order" },
    { name: "Draft Penawaran", icon: FileText, href: "/staff/draft-penawaran" },
    { name: "FAQ", icon: HelpCircle, href: "/staff/faq" },
    { name: "Profile Saya", icon: User, href: "/staff/profile-saya" },
  ];
