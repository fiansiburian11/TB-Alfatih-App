...
import SidebarSV from "../layout/sidebarsupervisor";
import Topbar from "./topbarsupervisor";

export default function SidebarSupervisor({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div>
      ...
      <div className={`fixed top-0 left-0 h-full transition-all duration-300 ${sidebarWidth}`}>
        <SidebarSV open={open} setOpen={setOpen} />
      </div>
